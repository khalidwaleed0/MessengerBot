...
public class OptionsGui extends JDialog {
    ...
    private final JTextField recordedKeyField;
    private final JLabel startStopLabel = new JLabel("Start/Stop Record");
    private final JButton btnListen = new JButton("listen");
    ...
    public OptionsGui() {
        ...
        if (AppSetup.Singleton().isRecordEnabled()) {
            ...
            if (recordedKey.contains("Mouse"))
                ...
                recordedKeyField.setText(KeyEvent.getKeyText(Integer.parseInt(recordedKey)));
            }
        }
